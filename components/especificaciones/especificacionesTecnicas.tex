\section{Especificaciones Técnicas }
  ...
  \subsection{Algoritmos implementados}
    ...
    \begin{enumerate}[label=\thesubsection.\arabic*, leftmargin=1.5cm]
      ...
      \item \textbf{Cálculo de anomalía térmica en la TSM - MODIS.}
      ...
      \item \textbf{Registro histórico del NDVI vs TSM.}
      ...
      \item \textbf{Cálculo de la correlación entre el NDVI y la TSM.}
